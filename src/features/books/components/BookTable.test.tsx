...
vi.mock("../hooks/api/useAuthorsMutation", () => ({
  useAuthorsMutation: vi.fn(),
}));

vi.mock("../hooks/api/useGenresMutation", () => ({
...
describe("BookTable", () => {
  ...
  test("renders books data correctly", () => {
    renderWithQueryClient(<BookTable />);
  ...
  test("renders with empty books array", () => {
    (useBooks as any).mockReturnValue({
      data: [],
      isLoading: false,
      isError: false,
  ...
  test("filters books based on search term", () => {
